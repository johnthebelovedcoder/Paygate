          ...
          <div
            ...
            onClick={async () => {
              try {
                ...
                // Currently, there's no API endpoint for segment-specific customers
                // So we'll fetch all customers and filter by segment (this is a temporary solution)
                // In a real implementation, the backend should have an endpoint like /customers/segments/{id}/customers
                const allCustomers = await customerService.getCustomers();
                
                // Since the backend doesn't currently support segment-specific customers,
                // we'll create mock customers for the segment (this is a placeholder until
