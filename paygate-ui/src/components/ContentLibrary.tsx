...
const ContentLibrary: React.FC<ContentLibraryProps> = ({ filterType = 'all' }) => {
  ...
  // If mobile device, render mobile-optimized version
  if (isMobile) {
    return <MobileContentLibrary filterType={filterType} />;
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3">
          <button
            ...
            className="inline-flex flex-shrink-0 items-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-600 min-w-[100px] justify-center touch-target"
          >
            {viewMode === 'grid' ? (
              <>
          ...
          <button
            ...
            className="inline-flex flex-shrink-0 items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:bg-green-500 dark:hover:bg-green-600 min-w-[80px] justify-center touch-target"
          >
            <svg className="h-5 w-5 mr-1 sm:mr-2 hidden xs:block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                strokeWidth="2"
          ...
          <button
            ...
            className="inline-flex flex-shrink-0 items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-600 min-w-[120px] justify-center touch-target"
          >
            <svg className="h-5 w-5 mr-1 sm:mr-2 hidden xs:block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
