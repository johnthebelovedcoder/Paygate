...
import { debounce } from '../utils/mobilePerformance.utils';
...
const MobileContentLibrary: React.FC<MobileContentLibraryProps> = ({ filterType = 'all' }) => {
  ...
  const [itemsPerPage] = useState(8); // Reduced for mobile
  const [viewMode, setViewMode] = useState<'grid' | 'list'>('grid'); // Added view mode toggle
  const fileRefs = useRef<Record<string, File>>({});
  const { t } = useTranslation();
  const { isSlowNetwork, imageQuality, enableVirtualScrolling } = useMobileOptimization();
    ...
    <div className="bg-white shadow rounded-lg p-4 dark:bg-gray-800 dark:shadow-gray-900/50">
              ...
              {paginatedItems.map(item => (
                ...
                >
                  <div className="p-4">
                    ...
                    <h3
                      className="text-md font-medium text-gray-900 mb-2 truncate dark:text-white cursor-pointer hover:text-indigo-600 dark:hover:text-indigo-400"
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 touch-target"
                        >
                          <svg
                            className="h-5 w-5"
                            fill="none"
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <div className="flex items-center space-x-2 justify-end">
                          ...
                          <button
                            ...
                            className="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 touch-target"
                          >
                            Delete
                          </button>
                        </div>
      ...
      {showPreview && previewItem && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-2">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto dark:bg-gray-800">
            <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300 touch-target"
                >
                ...
                <div>
                  ...
                  <dl className="mt-2 space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <dd className="text-sm text-gray-900 dark:text-white">
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(previewItem.status)}`}
                        >
            ...
            <div className="px-4 py-3 bg-gray-50 border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
