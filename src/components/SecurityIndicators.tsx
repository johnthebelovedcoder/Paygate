    ...
    <div className="mt-6 bg-gray-50 rounded-lg p-4 dark:bg-gray-800">
      ...
      <div className="mt-2 flex flex-wrap items-center gap-4">
        <div className="flex items-center">
          ...
          <span className="ml-1 text-xs text-gray-600 dark:text-gray-400">SSL Encryption</span>
        </div>
        <div className="flex items-center">
          <svg
            className="h-5 w-5 text-green-500"
          ...
          <span className="ml-1 text-xs text-gray-600 dark:text-gray-400">PCI DSS Compliant</span>
        </div>
        <div className="flex items-center">
          <svg
            className="h-5 w-5 text-green-500"
