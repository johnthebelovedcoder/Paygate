...
const mockRevenueData: RevenueData[] = [
  { date: 'Jan 1', revenue: 1200, sales: 12 },
  { date: 'Jan 2', revenue: 1800, sales: 18 },
  { date: 'Jan 3', revenue: 1500, sales: 15 },
  { date: 'Jan 4', revenue: 2100, sales: 21 },
  { date: 'Jan 5', revenue: 1900, sales: 19 },
  { date: 'Jan 6', revenue: 2300, sales: 23 },
  { date: 'Jan 7', revenue: 2700, sales: 27 },
];
...
const mockPaywallData: PaywallData[] = [
  { id: '1', title: 'Premium Content', revenue: 4500, conversions: 45, conversionRate: 8.5 },
  { id: '2', title: 'Basic Subscription', revenue: 3200, conversions: 64, conversionRate: 6.2 },
  { id: '3', title: 'One-time Purchase', revenue: 2800, conversions: 28, conversionRate: 5.1 },
  { id: '4', title: 'Service Package', revenue: 1200, conversions: 18, conversionRate: 4.7 },
  { id: '5', title: 'Digital Download', revenue: 750, conversions: 12, conversionRate: 3.9 },
];
...
const SimpleAnalyticsDashboard: React.FC = () => {
  ...
  const paywallData = mockPaywallData;
  const recentPaymentsData = mockRecentPayments;
  const stats = mockStats;

  // Use stats from mock data
  const totalRevenue = stats.totalRevenue;
  const totalVisitors = stats.totalVisitors;
  const totalConversions = stats.recentPayments; // Using recent payments as conversions for now
          ...
          <div className="px-4 py-6 sm:px-0">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white p-6 shadow rounded-lg dark:bg-gray-800 dark:shadow-gray-900/50">
                ...
                <div className="h-80">
                  <AnalyticsChart
                    data={revenueData.map(item => ({ name: item.date, value: item.revenue }))}
                    title="Revenue"
                    type="line"
                    color="indigo"
                    currency="USD"
              ...
              <div className="bg-white p-6 shadow rounded-lg dark:bg-gray-800 dark:shadow-gray-900/50">
                ...
                <div className="h-80">
                  {/* For multi-series bar chart, we'll use a single series with combined data */}
                  <AnalyticsChart
                    data={trafficData.map(item => ({ name: item.date, value: item.visitors }))}
                    title="Visitors"
                    type="bar"
                    color="indigo"
                    currency="USD"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white p-6 shadow rounded-lg dark:bg-gray-800 dark:shadow-gray-900/50">
                ...
                <div className="h-80">
                  <AnalyticsChart
                    data={conversionData.map(item => ({ name: item.date, value: item.conversions }))}
                    title="Conversions"
                    type="line"
                    color="green"
                    currency="USD"
              ...
              <div className="bg-white p-6 shadow rounded-lg dark:bg-gray-800 dark:shadow-gray-900/50">
                ...
                <div className="h-80">
                  <AnalyticsChart
                    data={paywallData.map(item => ({ name: item.title, value: item.revenue }))}
                    title="Top Paywalls"
                    type="donut"
                    color="purple"
                    currency="USD"
