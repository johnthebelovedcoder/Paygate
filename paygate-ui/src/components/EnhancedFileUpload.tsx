...
const EnhancedFileUpload: React.FC<FileUploadProps> = ({
  ...
  const getFileType = (fileType: string): 'document' | 'video' | 'audio' | 'image' | 'other' => {
  ...
  // Simulate file upload with progress using the same animation style as ContentLibraryV2
  ...
  return (
    <div>
      {/* Upload Progress Indicators - Same style as ContentLibraryV2 */}
      {uploadProgress.length > 0 && (
        <div className="mb-4 bg-white shadow rounded-lg p-4 dark:bg-gray-800 dark:shadow-gray-900/50">
